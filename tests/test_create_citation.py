...
APA_README_LINK = (
    "https://github.com/SimaoBolota-MetaCell/Citation_Examples/blob/main/APA_Example.md"
)
...
NOTHING_README_LINK = (
    "https://github.com/SimaoBolota-MetaCell/Citation_Examples/blob/main/NO_CITATION.md"
)
...
def test_bibtex_method():
    ...
    assert citation_url == [
        "https://www.biorxiv.org/content/early/2022/03/18/2022.03.17.484806"
    ]
    assert citation_doi == "10.1101/2022.03.17.484806"


def test_apa_method():
    APA_text_var, all_apa_authors_var, all_apa_citations_var = get_apa_citations(
        APA_README_LINK
    )
    (
        APA_text_var_doi,
        all_apa_authors_var_doi,
        all_apa_citations_var_doi,
    ) = get_apa_citations(DOI_README_LINK)
