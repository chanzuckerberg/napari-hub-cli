...
def create_cff_citation(repo_path, save=True, display_info=True):
    ...
    cff.override_with(first_citation)
    if save:
        cff.save()
    return True
...
#     elif bool(get_bibtex_citations(README_LINK)) == False and bool(
#         get_apa_citations(README_LINK)
#     ):
